...
import { SignerKeyChain, SignerKeyPair, StandardBaseTx, Credential, OutputOwners } from "../../common";
import { SerializedEncoding } from "../../utils/serialization";
/**
 * Class representing a base for all transactions.
 */
export declare class BaseTx extends StandardBaseTx<SignerKeyPair, SignerKeyChain> {
