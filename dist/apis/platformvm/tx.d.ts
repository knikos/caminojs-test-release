...
export declare class UnsignedTx extends StandardUnsignedTx<SignerKeyPair, SignerKeyChain, BaseTx> {
...
export declare class Tx extends StandardTx<SignerKeyPair, SignerKeyChain, UnsignedTx> {
    protected _typeName: string;
    protected _typeID: any;
    deserialize(fields: object, encoding?: SerializedEncoding): void;
    /**
