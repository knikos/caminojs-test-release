...
export declare class PlatformVMAPI extends JRPCAPI {
     ...
     * This helper exists because the endpoint API should be the primary point of entry for most functionality.
     */
    buildImportTx: (utxoset: UTXOSet, ownerAddresses: string[], sourceChain: Buffer | string, toAddresses: string[], fromAddresses: FromType, changeAddresses?: string[], memo?: PayloadBase | Buffer, asOf?: BN, locktime?: BN, toThreshold?: number, changeThreshold?: number) => Promise<UnsignedTx>;
    /**
     ...
     */
    buildExportTx: (utxoset: UTXOSet, amount: BN, destinationChain: Buffer | string, toAddresses: string[], fromAddresses: FromType, changeAddresses?: string[], memo?: PayloadBase | Buffer, asOf?: BN, locktime?: BN, toThreshold?: number, changeThreshold?: number) => Promise<UnsignedTx>;
    /**
     ...
     */
    buildAddSubnetValidatorTx: (utxoset: UTXOSet, fromAddresses: FromType, changeAddresses: string[], nodeID: string, startTime: BN, endTime: BN, weight: BN, subnetID: string, memo?: PayloadBase | Buffer, asOf?: BN, subnetAuth?: Auth, changeThreshold?: number) => Promise<UnsignedTx>;
    /**
     ...
     * @returns An unsigned transaction created from the passed in parameters.
     */
    buildCreateSubnetTx: (utxoset: UTXOSet, fromAddresses: FromType, changeAddresses: string[], subnetOwnerAddresses: string[], subnetOwnerThreshold: number, memo?: PayloadBase | Buffer, asOf?: BN, changeThreshold?: number) => Promise<UnsignedTx>;
    /**
     ...
     * @returns An unsigned transaction created from the passed in parameters.
     */
    buildRegisterNodeTx: (utxoset: UTXOSet, fromAddresses: FromType, changeAddresses?: string[], oldNodeID?: string | Buffer, newNodeID?: string | Buffer, address?: string | Buffer, addressAuths?: [number, string | Buffer][], memo?: PayloadBase | Buffer, asOf?: BN, changeThreshold?: number) => Promise<UnsignedTx>;
    /**
    ...
    protected _cleanAddressArrayBuffer(addresses: string[] | Buffer[], caller: string): Buffer[];
