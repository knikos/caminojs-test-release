...
import { BaseInput, StandardTransferableInput, StandardAmountInput, StandardParseableInput } from "../../common/input";
 ...
 */
export declare const SelectInputClass: (inputid: number, ...args: any[]) => BaseInput;
 ...
 */
export declare class StakeableLockIn extends ParseableInput {
    protected _typeName: string;
    protected _typeID: number;
 ...
 */
export declare class LockedIn extends ParseableInput {
    protected _typeName: string;
    protected _typeID: number;
    serialize(encoding?: SerializedEncoding): object;
    deserialize(fields: object, encoding?: SerializedEncoding): void;
