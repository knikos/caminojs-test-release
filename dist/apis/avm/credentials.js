...
const SelectCredentialClass = (credid, ...args) => {
    ...
    if (credid === constants_1.AVMConstants.NFTCREDENTIAL ||
        credid === constants_1.AVMConstants.NFTCREDENTIAL_CODECTWO) {
