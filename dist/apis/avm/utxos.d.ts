...
export declare class UTXOSet extends StandardUTXOSet<UTXO> {
     ...
     *
     */
    buildBaseTx: (networkID: number, blockchainID: Buffer, amount: BN, assetID: Buffer, toAddresses: Buffer[], fromAddresses: Buffer[], changeAddresses?: Buffer[], fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN, locktime?: BN, toThreshold?: number, changeThreshold?: number) => UnsignedTx;
    /**
     ...
     *
     */
    buildCreateAssetTx: (networkID: number, blockchainID: Buffer, fromAddresses: Buffer[], changeAddresses: Buffer[], initialState: InitialStates, name: string, symbol: string, denomination: number, mintOutputs?: SECPMintOutput[], fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN, changeThreshold?: number) => UnsignedTx;
    /**
     ...
     * @returns An unsigned transaction created from the passed in parameters.
     */
    buildSECPMintTx: (networkID: number, blockchainID: Buffer, mintOwner: SECPMintOutput, transferOwner: SECPTransferOutput, fromAddresses: Buffer[], changeAddresses: Buffer[], mintUTXOID: string, fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN, changeThreshold?: number) => UnsignedTx;
    /**
     * Creates an unsigned Create Asset transaction. For more granular control, you may create your own
     * [[CreateAssetTX]] manually (with their corresponding [[TransferableInput]]s, [[TransferableOutput]]s).
     *
     ...
     *
     */
    buildCreateNFTAssetTx: (networkID: number, blockchainID: Buffer, fromAddresses: Buffer[], changeAddresses: Buffer[], minterSets: MinterSet[], name: string, symbol: string, fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN, locktime?: BN, changeThreshold?: number) => UnsignedTx;
    /**
     ...
     *
     */
    buildCreateNFTMintTx: (networkID: number, blockchainID: Buffer, owners: OutputOwners[], fromAddresses: Buffer[], changeAddresses: Buffer[], utxoids: string[], groupID?: number, payload?: Buffer, fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN, changeThreshold?: number) => UnsignedTx;
    /**
     ...
     *
     */
    buildNFTTransferTx: (networkID: number, blockchainID: Buffer, toAddresses: Buffer[], fromAddresses: Buffer[], changeAddresses: Buffer[], utxoids: string[], fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN, locktime?: BN, toThreshold?: number, changeThreshold?: number) => UnsignedTx;
    /**
     ...
     *
     */
    buildImportTx: (networkID: number, blockchainID: Buffer, toAddresses: Buffer[], fromAddresses: Buffer[], changeAddresses: Buffer[], atomics: UTXO[], sourceChain?: Buffer, fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN, locktime?: BN, toThreshold?: number, changeThreshold?: number) => UnsignedTx;
    /**
     ...
     *
     */
    buildExportTx: (networkID: number, blockchainID: Buffer, amount: BN, assetID: Buffer, toAddresses: Buffer[], fromAddresses: Buffer[], changeAddresses?: Buffer[], destinationChain?: Buffer, fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN, locktime?: BN, toThreshold?: number, changeThreshold?: number) => UnsignedTx;
}
