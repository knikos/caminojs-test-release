 ...
 */
export declare abstract class SignerKeyPair {
 ...
 */
export declare abstract class StandardKeyPair extends SignerKeyPair {
    protected pubk: Buffer;
    protected privk: Buffer;
    /**
...
export declare abstract class SignerKeyChain {
    /**
