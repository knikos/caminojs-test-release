...
export declare abstract class StandardUTXO extends Serializable {
    ...
    abstract clone(): this;
    abstract create(codecID?: number, txid?: Buffer, outputidx?: Buffer | number, assetID?: Buffer, output?: BaseOutput): this;
    /**
     * Class for representing a single StandardUTXO.
     *
     ...
     */
    constructor(codecID?: number, txID?: Buffer, outputidx?: Buffer | number, assetID?: Buffer, output?: BaseOutput);
}
/**
