 ...
 */
export declare abstract class StandardBaseTx<KPClass extends SignerKeyPair, KCClass extends SignerKeyChain> extends Serializable {
 ...
 */
export declare abstract class StandardUnsignedTx<KPClass extends SignerKeyPair, KCClass extends SignerKeyChain, SBTx extends StandardBaseTx<KPClass, KCClass>> extends Serializable {
    protected _typeName: string;
    protected _typeID: any;
    serialize(encoding?: SerializedEncoding): object;
    deserialize(fields: object, encoding?: SerializedEncoding): void;
 ...
 */
export declare abstract class StandardTx<KPClass extends SignerKeyPair, KCClass extends SignerKeyChain, SUBTx extends StandardUnsignedTx<KPClass, KCClass, StandardBaseTx<KPClass, KCClass>>> extends Serializable {
    protected _typeName: string;
    protected _typeID: any;
    serialize(encoding?: SerializedEncoding): object;
