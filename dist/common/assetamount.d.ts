...
export declare abstract class StandardAssetAmountDestination<TO extends StandardTransferableOutput, TI extends StandardTransferableInput> {
    ...
    protected destinationsThreshold: number;
    protected senders: Buffer[];
    protected changeAddresses: Buffer[];
    protected changeAddressesThreshold: number;
    ...
    getAllOutputs: () => TO[];
    canComplete: () => boolean;
    constructor(destinations: Buffer[], destinationsThreshold: number, senders: Buffer[], changeAddresses: Buffer[], changeAddressesThreshold: number);
}
