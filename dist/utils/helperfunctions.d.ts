...
export declare function costImportTx(c: C, tx: UnsignedTx): number;
export declare function calcBytesCost(c: C, len: number): number;
export declare function costExportTx(c: C, tx: UnsignedTx): number;
